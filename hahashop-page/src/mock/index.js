...
Mock.mock(baseurl+"/order/sellerlist?goodId=10086", 'get', require('./json/shop/orders1.json'));
Mock.mock(baseurl+"/order/sellerlist?goodId=10087", 'get', require('./json/shop/orders2.json'));
