...
public class ManageProductTest extends BaseTest {

    @Test
    public void testFreezeProduct() {
    	loginAsSeller();
    ...
    public void testWithdrawProduct() {
        ...
        driver.findElement(By.xpath("//*[@id=\"goods\"]/div[3]/div[5]/div[2]/table/tbody/tr/td[6]/div/div/button[2]")).click();
